...
public class Registration_Excel_StepDefinition {
	...
	public void user_should_have_launched_the_application() throws Throwable {
		System.setProperty("webdriver.chrome.driver", "C://SDET -Full Stack Tester//Selenium//Selenium Downloads//chromedriver_win32//chromedriver.exe");
	...
	@When("^Click on Courses icon$")
	public void click_on_Courses_icon() throws Throwable {
		//for student
		driver.findElements(By.xpath("//input[@class='register-profile']")).get(1).click();
		//for teacher
		//driver.findElements(By.xpath("//input[@class='register-profile']")).get(2).click();
	}
	...
	public void varidate_the_successful_registration_message() throws Throwable {
		String actText=driver.findElement(By.xpath("//li[text()='Registration']")).getText();
