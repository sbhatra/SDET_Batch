...
Feature: Title of your feature
  ...
  Scenario Outline: TO verify whether application allows user to get registered as Student
    ...
    Examples: 
      ...
      | fname1     | lname1    | one@one.com | hello501   | one      | one              |   123 | English  | An e-mail has been sent to remind you of your login and password.   |
      | fname1     | lname1    | one@one.com | hello502   | one      | one              |   123 | English  | An e-mail has been sent to remind you of your login and password.  |
      | fname1     | lname1    | one@one.com | hello503   | one      | one              |   123 | English  | An e-mail has been sent to remind you of your login and password.   |
      | fname1     | lname1    | one@one.com | hello504   | one      | one              |   123 | English  | An e-mail has been sent to remind you of your login and password.   |
